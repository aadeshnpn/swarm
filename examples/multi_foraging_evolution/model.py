...
filename = os.path.join(projectdir + "/multi_foraging_evolution/world.json")
...
class ForagingModel(Model):
    ...
    def __init__(
            ...
            seed=None, name='MForaging', viewer=False):
        ...
        try:
            ...
            for site in self.render.objects['sites']:
                ...
                for i in range(self.num_agents * 1):
                    f = Food(
                        j, location=site.location, radius=site.radius)
                    f.agent_name = None
    ...
    def detect_food_moved(self):
        """Detect food moved."""
        grid = self.grid
        food_loc = self.sites[0].location
...
class EvolveModel(ForagingModel):
    ...
    def __init__(
            self, N, width, height, grid=10, iter=100000,
            seed=None, name="EvoMForge", viewer=False):
        """Initialize the attributes."""
...
class ValidationModel(ForagingModel):
    ...
    def __init__(
            self, N, width, height, grid=10, iter=100000,
            seed=None, name="ValidateMForge", viewer=False):
        """Initialize the attributes."""
...
class TestModel(ForagingModel):
    ...
    def __init__(
            self, N, width, height, grid=10, iter=100000,
            seed=None, name="TestMForge", viewer=False):
        """Initialize the attributes."""
...
class ViewerModel(ForagingModel):
    ...
    def __init__(
            self, N, width, height, grid=10, iter=100000,
            seed=None, name="TestMForge", viewer=True):
        """Initialize the attributes."""
