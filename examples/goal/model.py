...
class NMModel(Model):
    """A environemnt to model Goal environment."""

    def __init__(
            self, N, width, height, grid=10, iter=100000,
            seed=None, name='Goal', viewer=False,
        ...
        try:
            ...
            for site in self.render.objects['sites']:
                ...
                for i in range(self.num_agents * 1):
                    food_radius = self.random.randint(8, 30)
                    f = Food(
                        j, location=site.location, radius=food_radius)
                    f.agent_name = None
...
class EvolveModel(NMModel):
    ...
    def __init__(
            self, N, width, height, grid=10, iter=100000,
            seed=None, name="EvoGoal", viewer=False):
        """Initialize the attributes."""
...
class ValidationModel(NMModel):
    ...
    def __init__(
            self, N, width, height, grid=10, iter=100000,
            seed=None, name="ValidateGoal", viewer=False,
            parent=None, ratio=1.0):
        """Initialize the attributes."""
...
class TestModel(NMModel):
    ...
    def __init__(
            self, N, width, height, grid=10, iter=100000,
            seed=None, name="TestGoal", viewer=False):
        """Initialize the attributes."""
...
class ViewerModel(NMModel):
    ...
    def __init__(
            self, N, width, height, grid=10, iter=100000,
            seed=None, name="ViewerGoal", viewer=True):
        """Initialize the attributes."""
