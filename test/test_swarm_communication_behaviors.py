...
from swarms.behaviors.scbehaviors import (
    Explore, CompositeSendSignal, CompositeReceiveSignal
    )
...
# def main():
#     environment = ReceiveSignalModel(2, 100, 100, 10, 123)

#     for i in range(4):
#         agents = environment.agents
#         print(i, 'agent ', [a.location for a in agents], [len(a.shared_content.keys()) for a in agents])
#         print(agents[0].shared_content, agents[1].shared_content)
#         environment.step()

#     # print(environment.agent.location, environment.agent.signals[0].location)
#     _, glist = environment.grid.find_grid(environment.agent.location)
#     sobjs = environment.grid.get_objects('Signal', glist)
#     print([o.communicated_object for o in sobjs])
